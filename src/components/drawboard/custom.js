...
// 绘制箭头
export function register_arror_draw(name, drawboard) {
...
// 绘制勾
export function register_right_draw(name, drawboard) {
    drawboard.register_custom_draw_func({
        name,
        event: 'up',
...
// 绘制叉
export function register_wrong_draw(name, drawboard) {
    drawboard.register_custom_draw_func({
        name,
        event: 'up',
        get_draw_path_options(from, _, width) {
...
// 绘制 A+
export function register_aplus_draw(name, drawboard) {
    drawboard.register_custom_draw_func({
        name,
        type: 'text',
        event: 'up',
...
// 绘制 A-
export function register_aminus_draw(name, drawboard) {
    drawboard.register_custom_draw_func({
        name,
        type: 'text',
        event: 'up',
